...
module procesador_mm_interconnect_0 (
		...
		input  wire        fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset, // fifo_resultados_fase_reset_in_reset_bridge_in_reset.reset
		...
		output wire [0:0]  fifo_fft_imag_out_address,                                 //                                   fifo_fft_imag_out.address
		output wire        fifo_fft_imag_out_read,                                    //                                                    .read
		input  wire [31:0] fifo_fft_imag_out_readdata,                                //                                                    .readdata
		output wire [0:0]  fifo_fft_real_out_address,                                 //                                   fifo_fft_real_out.address
		output wire        fifo_fft_real_out_read,                                    //                                                    .read
		input  wire [31:0] fifo_fft_real_out_readdata,                                //                                                    .readdata
		output wire [0:0]  fifo_resultados_cuad_out_address,                          //                            fifo_resultados_cuad_out.address
		output wire        fifo_resultados_cuad_out_read,                             //                                                    .read
		input  wire [31:0] fifo_resultados_cuad_out_readdata,                         //                                                    .readdata
		output wire [0:0]  fifo_resultados_fase_out_address,                          //                            fifo_resultados_fase_out.address
		output wire        fifo_resultados_fase_out_read,                             //                                                    .read
		input  wire [31:0] fifo_resultados_fase_out_readdata,                         //                                                    .readdata
	...
	wire  [31:0] fifo_resultados_fase_out_agent_m0_readdata;                                         // fifo_resultados_fase_out_translator:uav_readdata -> fifo_resultados_fase_out_agent:m0_readdata
	wire         fifo_resultados_fase_out_agent_m0_waitrequest;                                      // fifo_resultados_fase_out_translator:uav_waitrequest -> fifo_resultados_fase_out_agent:m0_waitrequest
	wire         fifo_resultados_fase_out_agent_m0_debugaccess;                                      // fifo_resultados_fase_out_agent:m0_debugaccess -> fifo_resultados_fase_out_translator:uav_debugaccess
	wire  [18:0] fifo_resultados_fase_out_agent_m0_address;                                          // fifo_resultados_fase_out_agent:m0_address -> fifo_resultados_fase_out_translator:uav_address
	wire   [3:0] fifo_resultados_fase_out_agent_m0_byteenable;                                       // fifo_resultados_fase_out_agent:m0_byteenable -> fifo_resultados_fase_out_translator:uav_byteenable
	wire         fifo_resultados_fase_out_agent_m0_read;                                             // fifo_resultados_fase_out_agent:m0_read -> fifo_resultados_fase_out_translator:uav_read
	wire         fifo_resultados_fase_out_agent_m0_readdatavalid;                                    // fifo_resultados_fase_out_translator:uav_readdatavalid -> fifo_resultados_fase_out_agent:m0_readdatavalid
	wire         fifo_resultados_fase_out_agent_m0_lock;                                             // fifo_resultados_fase_out_agent:m0_lock -> fifo_resultados_fase_out_translator:uav_lock
	wire  [31:0] fifo_resultados_fase_out_agent_m0_writedata;                                        // fifo_resultados_fase_out_agent:m0_writedata -> fifo_resultados_fase_out_translator:uav_writedata
	wire         fifo_resultados_fase_out_agent_m0_write;                                            // fifo_resultados_fase_out_agent:m0_write -> fifo_resultados_fase_out_translator:uav_write
	wire   [2:0] fifo_resultados_fase_out_agent_m0_burstcount;                                       // fifo_resultados_fase_out_agent:m0_burstcount -> fifo_resultados_fase_out_translator:uav_burstcount
	wire         fifo_resultados_fase_out_agent_rf_source_valid;                                     // fifo_resultados_fase_out_agent:rf_source_valid -> fifo_resultados_fase_out_agent_rsp_fifo:in_valid
	wire  [97:0] fifo_resultados_fase_out_agent_rf_source_data;                                      // fifo_resultados_fase_out_agent:rf_source_data -> fifo_resultados_fase_out_agent_rsp_fifo:in_data
	wire         fifo_resultados_fase_out_agent_rf_source_ready;                                     // fifo_resultados_fase_out_agent_rsp_fifo:in_ready -> fifo_resultados_fase_out_agent:rf_source_ready
	wire         fifo_resultados_fase_out_agent_rf_source_startofpacket;                             // fifo_resultados_fase_out_agent:rf_source_startofpacket -> fifo_resultados_fase_out_agent_rsp_fifo:in_startofpacket
	wire         fifo_resultados_fase_out_agent_rf_source_endofpacket;                               // fifo_resultados_fase_out_agent:rf_source_endofpacket -> fifo_resultados_fase_out_agent_rsp_fifo:in_endofpacket
	wire         fifo_resultados_fase_out_agent_rsp_fifo_out_valid;                                  // fifo_resultados_fase_out_agent_rsp_fifo:out_valid -> fifo_resultados_fase_out_agent:rf_sink_valid
	wire  [97:0] fifo_resultados_fase_out_agent_rsp_fifo_out_data;                                   // fifo_resultados_fase_out_agent_rsp_fifo:out_data -> fifo_resultados_fase_out_agent:rf_sink_data
	wire         fifo_resultados_fase_out_agent_rsp_fifo_out_ready;                                  // fifo_resultados_fase_out_agent:rf_sink_ready -> fifo_resultados_fase_out_agent_rsp_fifo:out_ready
	wire         fifo_resultados_fase_out_agent_rsp_fifo_out_startofpacket;                          // fifo_resultados_fase_out_agent_rsp_fifo:out_startofpacket -> fifo_resultados_fase_out_agent:rf_sink_startofpacket
	wire         fifo_resultados_fase_out_agent_rsp_fifo_out_endofpacket;                            // fifo_resultados_fase_out_agent_rsp_fifo:out_endofpacket -> fifo_resultados_fase_out_agent:rf_sink_endofpacket
	wire         fifo_resultados_fase_out_agent_rdata_fifo_src_valid;                                // fifo_resultados_fase_out_agent:rdata_fifo_src_valid -> fifo_resultados_fase_out_agent_rdata_fifo:in_valid
	wire  [33:0] fifo_resultados_fase_out_agent_rdata_fifo_src_data;                                 // fifo_resultados_fase_out_agent:rdata_fifo_src_data -> fifo_resultados_fase_out_agent_rdata_fifo:in_data
	wire         fifo_resultados_fase_out_agent_rdata_fifo_src_ready;                                // fifo_resultados_fase_out_agent_rdata_fifo:in_ready -> fifo_resultados_fase_out_agent:rdata_fifo_src_ready
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> fifo_resultados_fase_out_agent:cp_valid
	wire  [96:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> fifo_resultados_fase_out_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // fifo_resultados_fase_out_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> fifo_resultados_fase_out_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> fifo_resultados_fase_out_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> fifo_resultados_fase_out_agent:cp_endofpacket
	wire  [31:0] fifo_resultados_cuad_out_agent_m0_readdata;                                         // fifo_resultados_cuad_out_translator:uav_readdata -> fifo_resultados_cuad_out_agent:m0_readdata
	wire         fifo_resultados_cuad_out_agent_m0_waitrequest;                                      // fifo_resultados_cuad_out_translator:uav_waitrequest -> fifo_resultados_cuad_out_agent:m0_waitrequest
	wire         fifo_resultados_cuad_out_agent_m0_debugaccess;                                      // fifo_resultados_cuad_out_agent:m0_debugaccess -> fifo_resultados_cuad_out_translator:uav_debugaccess
	wire  [18:0] fifo_resultados_cuad_out_agent_m0_address;                                          // fifo_resultados_cuad_out_agent:m0_address -> fifo_resultados_cuad_out_translator:uav_address
	wire   [3:0] fifo_resultados_cuad_out_agent_m0_byteenable;                                       // fifo_resultados_cuad_out_agent:m0_byteenable -> fifo_resultados_cuad_out_translator:uav_byteenable
	wire         fifo_resultados_cuad_out_agent_m0_read;                                             // fifo_resultados_cuad_out_agent:m0_read -> fifo_resultados_cuad_out_translator:uav_read
	wire         fifo_resultados_cuad_out_agent_m0_readdatavalid;                                    // fifo_resultados_cuad_out_translator:uav_readdatavalid -> fifo_resultados_cuad_out_agent:m0_readdatavalid
	wire         fifo_resultados_cuad_out_agent_m0_lock;                                             // fifo_resultados_cuad_out_agent:m0_lock -> fifo_resultados_cuad_out_translator:uav_lock
	wire  [31:0] fifo_resultados_cuad_out_agent_m0_writedata;                                        // fifo_resultados_cuad_out_agent:m0_writedata -> fifo_resultados_cuad_out_translator:uav_writedata
	wire         fifo_resultados_cuad_out_agent_m0_write;                                            // fifo_resultados_cuad_out_agent:m0_write -> fifo_resultados_cuad_out_translator:uav_write
	wire   [2:0] fifo_resultados_cuad_out_agent_m0_burstcount;                                       // fifo_resultados_cuad_out_agent:m0_burstcount -> fifo_resultados_cuad_out_translator:uav_burstcount
	wire         fifo_resultados_cuad_out_agent_rf_source_valid;                                     // fifo_resultados_cuad_out_agent:rf_source_valid -> fifo_resultados_cuad_out_agent_rsp_fifo:in_valid
	wire  [97:0] fifo_resultados_cuad_out_agent_rf_source_data;                                      // fifo_resultados_cuad_out_agent:rf_source_data -> fifo_resultados_cuad_out_agent_rsp_fifo:in_data
	wire         fifo_resultados_cuad_out_agent_rf_source_ready;                                     // fifo_resultados_cuad_out_agent_rsp_fifo:in_ready -> fifo_resultados_cuad_out_agent:rf_source_ready
	wire         fifo_resultados_cuad_out_agent_rf_source_startofpacket;                             // fifo_resultados_cuad_out_agent:rf_source_startofpacket -> fifo_resultados_cuad_out_agent_rsp_fifo:in_startofpacket
	wire         fifo_resultados_cuad_out_agent_rf_source_endofpacket;                               // fifo_resultados_cuad_out_agent:rf_source_endofpacket -> fifo_resultados_cuad_out_agent_rsp_fifo:in_endofpacket
	wire         fifo_resultados_cuad_out_agent_rsp_fifo_out_valid;                                  // fifo_resultados_cuad_out_agent_rsp_fifo:out_valid -> fifo_resultados_cuad_out_agent:rf_sink_valid
	wire  [97:0] fifo_resultados_cuad_out_agent_rsp_fifo_out_data;                                   // fifo_resultados_cuad_out_agent_rsp_fifo:out_data -> fifo_resultados_cuad_out_agent:rf_sink_data
	wire         fifo_resultados_cuad_out_agent_rsp_fifo_out_ready;                                  // fifo_resultados_cuad_out_agent:rf_sink_ready -> fifo_resultados_cuad_out_agent_rsp_fifo:out_ready
	wire         fifo_resultados_cuad_out_agent_rsp_fifo_out_startofpacket;                          // fifo_resultados_cuad_out_agent_rsp_fifo:out_startofpacket -> fifo_resultados_cuad_out_agent:rf_sink_startofpacket
	wire         fifo_resultados_cuad_out_agent_rsp_fifo_out_endofpacket;                            // fifo_resultados_cuad_out_agent_rsp_fifo:out_endofpacket -> fifo_resultados_cuad_out_agent:rf_sink_endofpacket
	wire         fifo_resultados_cuad_out_agent_rdata_fifo_src_valid;                                // fifo_resultados_cuad_out_agent:rdata_fifo_src_valid -> fifo_resultados_cuad_out_agent_rdata_fifo:in_valid
	wire  [33:0] fifo_resultados_cuad_out_agent_rdata_fifo_src_data;                                 // fifo_resultados_cuad_out_agent:rdata_fifo_src_data -> fifo_resultados_cuad_out_agent_rdata_fifo:in_data
	wire         fifo_resultados_cuad_out_agent_rdata_fifo_src_ready;                                // fifo_resultados_cuad_out_agent_rdata_fifo:in_ready -> fifo_resultados_cuad_out_agent:rdata_fifo_src_ready
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> fifo_resultados_cuad_out_agent:cp_valid
	wire  [96:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> fifo_resultados_cuad_out_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // fifo_resultados_cuad_out_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> fifo_resultados_cuad_out_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> fifo_resultados_cuad_out_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> fifo_resultados_cuad_out_agent:cp_endofpacket
	wire  [31:0] fifo_fft_real_out_agent_m0_readdata;                                                // fifo_fft_real_out_translator:uav_readdata -> fifo_fft_real_out_agent:m0_readdata
	wire         fifo_fft_real_out_agent_m0_waitrequest;                                             // fifo_fft_real_out_translator:uav_waitrequest -> fifo_fft_real_out_agent:m0_waitrequest
	wire         fifo_fft_real_out_agent_m0_debugaccess;                                             // fifo_fft_real_out_agent:m0_debugaccess -> fifo_fft_real_out_translator:uav_debugaccess
	wire  [18:0] fifo_fft_real_out_agent_m0_address;                                                 // fifo_fft_real_out_agent:m0_address -> fifo_fft_real_out_translator:uav_address
	wire   [3:0] fifo_fft_real_out_agent_m0_byteenable;                                              // fifo_fft_real_out_agent:m0_byteenable -> fifo_fft_real_out_translator:uav_byteenable
	wire         fifo_fft_real_out_agent_m0_read;                                                    // fifo_fft_real_out_agent:m0_read -> fifo_fft_real_out_translator:uav_read
	wire         fifo_fft_real_out_agent_m0_readdatavalid;                                           // fifo_fft_real_out_translator:uav_readdatavalid -> fifo_fft_real_out_agent:m0_readdatavalid
	wire         fifo_fft_real_out_agent_m0_lock;                                                    // fifo_fft_real_out_agent:m0_lock -> fifo_fft_real_out_translator:uav_lock
	wire  [31:0] fifo_fft_real_out_agent_m0_writedata;                                               // fifo_fft_real_out_agent:m0_writedata -> fifo_fft_real_out_translator:uav_writedata
	wire         fifo_fft_real_out_agent_m0_write;                                                   // fifo_fft_real_out_agent:m0_write -> fifo_fft_real_out_translator:uav_write
	wire   [2:0] fifo_fft_real_out_agent_m0_burstcount;                                              // fifo_fft_real_out_agent:m0_burstcount -> fifo_fft_real_out_translator:uav_burstcount
	wire         fifo_fft_real_out_agent_rf_source_valid;                                            // fifo_fft_real_out_agent:rf_source_valid -> fifo_fft_real_out_agent_rsp_fifo:in_valid
	wire  [97:0] fifo_fft_real_out_agent_rf_source_data;                                             // fifo_fft_real_out_agent:rf_source_data -> fifo_fft_real_out_agent_rsp_fifo:in_data
	wire         fifo_fft_real_out_agent_rf_source_ready;                                            // fifo_fft_real_out_agent_rsp_fifo:in_ready -> fifo_fft_real_out_agent:rf_source_ready
	wire         fifo_fft_real_out_agent_rf_source_startofpacket;                                    // fifo_fft_real_out_agent:rf_source_startofpacket -> fifo_fft_real_out_agent_rsp_fifo:in_startofpacket
	wire         fifo_fft_real_out_agent_rf_source_endofpacket;                                      // fifo_fft_real_out_agent:rf_source_endofpacket -> fifo_fft_real_out_agent_rsp_fifo:in_endofpacket
	wire         fifo_fft_real_out_agent_rsp_fifo_out_valid;                                         // fifo_fft_real_out_agent_rsp_fifo:out_valid -> fifo_fft_real_out_agent:rf_sink_valid
	wire  [97:0] fifo_fft_real_out_agent_rsp_fifo_out_data;                                          // fifo_fft_real_out_agent_rsp_fifo:out_data -> fifo_fft_real_out_agent:rf_sink_data
	wire         fifo_fft_real_out_agent_rsp_fifo_out_ready;                                         // fifo_fft_real_out_agent:rf_sink_ready -> fifo_fft_real_out_agent_rsp_fifo:out_ready
	wire         fifo_fft_real_out_agent_rsp_fifo_out_startofpacket;                                 // fifo_fft_real_out_agent_rsp_fifo:out_startofpacket -> fifo_fft_real_out_agent:rf_sink_startofpacket
	wire         fifo_fft_real_out_agent_rsp_fifo_out_endofpacket;                                   // fifo_fft_real_out_agent_rsp_fifo:out_endofpacket -> fifo_fft_real_out_agent:rf_sink_endofpacket
	wire         fifo_fft_real_out_agent_rdata_fifo_src_valid;                                       // fifo_fft_real_out_agent:rdata_fifo_src_valid -> fifo_fft_real_out_agent_rdata_fifo:in_valid
	wire  [33:0] fifo_fft_real_out_agent_rdata_fifo_src_data;                                        // fifo_fft_real_out_agent:rdata_fifo_src_data -> fifo_fft_real_out_agent_rdata_fifo:in_data
	wire         fifo_fft_real_out_agent_rdata_fifo_src_ready;                                       // fifo_fft_real_out_agent_rdata_fifo:in_ready -> fifo_fft_real_out_agent:rdata_fifo_src_ready
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> fifo_fft_real_out_agent:cp_valid
	wire  [96:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> fifo_fft_real_out_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // fifo_fft_real_out_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> fifo_fft_real_out_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> fifo_fft_real_out_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> fifo_fft_real_out_agent:cp_endofpacket
	wire  [31:0] fifo_fft_imag_out_agent_m0_readdata;                                                // fifo_fft_imag_out_translator:uav_readdata -> fifo_fft_imag_out_agent:m0_readdata
	wire         fifo_fft_imag_out_agent_m0_waitrequest;                                             // fifo_fft_imag_out_translator:uav_waitrequest -> fifo_fft_imag_out_agent:m0_waitrequest
	wire         fifo_fft_imag_out_agent_m0_debugaccess;                                             // fifo_fft_imag_out_agent:m0_debugaccess -> fifo_fft_imag_out_translator:uav_debugaccess
	wire  [18:0] fifo_fft_imag_out_agent_m0_address;                                                 // fifo_fft_imag_out_agent:m0_address -> fifo_fft_imag_out_translator:uav_address
	wire   [3:0] fifo_fft_imag_out_agent_m0_byteenable;                                              // fifo_fft_imag_out_agent:m0_byteenable -> fifo_fft_imag_out_translator:uav_byteenable
	wire         fifo_fft_imag_out_agent_m0_read;                                                    // fifo_fft_imag_out_agent:m0_read -> fifo_fft_imag_out_translator:uav_read
	wire         fifo_fft_imag_out_agent_m0_readdatavalid;                                           // fifo_fft_imag_out_translator:uav_readdatavalid -> fifo_fft_imag_out_agent:m0_readdatavalid
	wire         fifo_fft_imag_out_agent_m0_lock;                                                    // fifo_fft_imag_out_agent:m0_lock -> fifo_fft_imag_out_translator:uav_lock
	wire  [31:0] fifo_fft_imag_out_agent_m0_writedata;                                               // fifo_fft_imag_out_agent:m0_writedata -> fifo_fft_imag_out_translator:uav_writedata
	wire         fifo_fft_imag_out_agent_m0_write;                                                   // fifo_fft_imag_out_agent:m0_write -> fifo_fft_imag_out_translator:uav_write
	wire   [2:0] fifo_fft_imag_out_agent_m0_burstcount;                                              // fifo_fft_imag_out_agent:m0_burstcount -> fifo_fft_imag_out_translator:uav_burstcount
	wire         fifo_fft_imag_out_agent_rf_source_valid;                                            // fifo_fft_imag_out_agent:rf_source_valid -> fifo_fft_imag_out_agent_rsp_fifo:in_valid
	wire  [97:0] fifo_fft_imag_out_agent_rf_source_data;                                             // fifo_fft_imag_out_agent:rf_source_data -> fifo_fft_imag_out_agent_rsp_fifo:in_data
	wire         fifo_fft_imag_out_agent_rf_source_ready;                                            // fifo_fft_imag_out_agent_rsp_fifo:in_ready -> fifo_fft_imag_out_agent:rf_source_ready
	wire         fifo_fft_imag_out_agent_rf_source_startofpacket;                                    // fifo_fft_imag_out_agent:rf_source_startofpacket -> fifo_fft_imag_out_agent_rsp_fifo:in_startofpacket
	wire         fifo_fft_imag_out_agent_rf_source_endofpacket;                                      // fifo_fft_imag_out_agent:rf_source_endofpacket -> fifo_fft_imag_out_agent_rsp_fifo:in_endofpacket
	wire         fifo_fft_imag_out_agent_rsp_fifo_out_valid;                                         // fifo_fft_imag_out_agent_rsp_fifo:out_valid -> fifo_fft_imag_out_agent:rf_sink_valid
	wire  [97:0] fifo_fft_imag_out_agent_rsp_fifo_out_data;                                          // fifo_fft_imag_out_agent_rsp_fifo:out_data -> fifo_fft_imag_out_agent:rf_sink_data
	wire         fifo_fft_imag_out_agent_rsp_fifo_out_ready;                                         // fifo_fft_imag_out_agent:rf_sink_ready -> fifo_fft_imag_out_agent_rsp_fifo:out_ready
	wire         fifo_fft_imag_out_agent_rsp_fifo_out_startofpacket;                                 // fifo_fft_imag_out_agent_rsp_fifo:out_startofpacket -> fifo_fft_imag_out_agent:rf_sink_startofpacket
	wire         fifo_fft_imag_out_agent_rsp_fifo_out_endofpacket;                                   // fifo_fft_imag_out_agent_rsp_fifo:out_endofpacket -> fifo_fft_imag_out_agent:rf_sink_endofpacket
	wire         fifo_fft_imag_out_agent_rdata_fifo_src_valid;                                       // fifo_fft_imag_out_agent:rdata_fifo_src_valid -> fifo_fft_imag_out_agent_rdata_fifo:in_valid
	wire  [33:0] fifo_fft_imag_out_agent_rdata_fifo_src_data;                                        // fifo_fft_imag_out_agent:rdata_fifo_src_data -> fifo_fft_imag_out_agent_rdata_fifo:in_data
	wire         fifo_fft_imag_out_agent_rdata_fifo_src_ready;                                       // fifo_fft_imag_out_agent_rdata_fifo:in_ready -> fifo_fft_imag_out_agent:rdata_fifo_src_ready
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> fifo_fft_imag_out_agent:cp_valid
	wire  [96:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> fifo_fft_imag_out_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // fifo_fft_imag_out_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> fifo_fft_imag_out_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> fifo_fft_imag_out_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> fifo_fft_imag_out_agent:cp_endofpacket
	...
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> program_memory_s1_agent:cp_channel
	...
	wire  [18:0] reset_s1_agent_m0_address;                                                          // reset_s1_agent:m0_address -> reset_s1_translator:uav_address
	...
	wire  [97:0] reset_s1_agent_rf_source_data;                                                      // reset_s1_agent:rf_source_data -> reset_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] reset_s1_agent_rsp_fifo_out_data;                                                   // reset_s1_agent_rsp_fifo:out_data -> reset_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> reset_s1_agent:cp_data
	...
	wire  [18:0] enable_s1_agent_m0_address;                                                         // enable_s1_agent:m0_address -> enable_s1_translator:uav_address
	...
	wire  [97:0] enable_s1_agent_rf_source_data;                                                     // enable_s1_agent:rf_source_data -> enable_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] enable_s1_agent_rsp_fifo_out_data;                                                  // enable_s1_agent_rsp_fifo:out_data -> enable_s1_agent:rf_sink_data
	...
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> enable_s1_agent:cp_valid
	wire  [96:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> enable_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // enable_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> enable_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> enable_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> enable_s1_agent:cp_endofpacket
	...
	wire         fifo_resultados_fase_out_agent_rp_valid;                                            // fifo_resultados_fase_out_agent:rp_valid -> router_004:sink_valid
	wire  [96:0] fifo_resultados_fase_out_agent_rp_data;                                             // fifo_resultados_fase_out_agent:rp_data -> router_004:sink_data
	wire         fifo_resultados_fase_out_agent_rp_ready;                                            // router_004:sink_ready -> fifo_resultados_fase_out_agent:rp_ready
	wire         fifo_resultados_fase_out_agent_rp_startofpacket;                                    // fifo_resultados_fase_out_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         fifo_resultados_fase_out_agent_rp_endofpacket;                                      // fifo_resultados_fase_out_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         fifo_resultados_cuad_out_agent_rp_valid;                                            // fifo_resultados_cuad_out_agent:rp_valid -> router_005:sink_valid
	wire  [96:0] fifo_resultados_cuad_out_agent_rp_data;                                             // fifo_resultados_cuad_out_agent:rp_data -> router_005:sink_data
	wire         fifo_resultados_cuad_out_agent_rp_ready;                                            // router_005:sink_ready -> fifo_resultados_cuad_out_agent:rp_ready
	wire         fifo_resultados_cuad_out_agent_rp_startofpacket;                                    // fifo_resultados_cuad_out_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         fifo_resultados_cuad_out_agent_rp_endofpacket;                                      // fifo_resultados_cuad_out_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         fifo_fft_real_out_agent_rp_valid;                                                   // fifo_fft_real_out_agent:rp_valid -> router_006:sink_valid
	wire  [96:0] fifo_fft_real_out_agent_rp_data;                                                    // fifo_fft_real_out_agent:rp_data -> router_006:sink_data
	wire         fifo_fft_real_out_agent_rp_ready;                                                   // router_006:sink_ready -> fifo_fft_real_out_agent:rp_ready
	wire         fifo_fft_real_out_agent_rp_startofpacket;                                           // fifo_fft_real_out_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         fifo_fft_real_out_agent_rp_endofpacket;                                             // fifo_fft_real_out_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         fifo_fft_imag_out_agent_rp_valid;                                                   // fifo_fft_imag_out_agent:rp_valid -> router_007:sink_valid
	wire  [96:0] fifo_fft_imag_out_agent_rp_data;                                                    // fifo_fft_imag_out_agent:rp_data -> router_007:sink_data
	wire         fifo_fft_imag_out_agent_rp_ready;                                                   // router_007:sink_ready -> fifo_fft_imag_out_agent:rp_ready
	wire         fifo_fft_imag_out_agent_rp_startofpacket;                                           // fifo_fft_imag_out_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         fifo_fft_imag_out_agent_rp_endofpacket;                                             // fifo_fft_imag_out_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [96:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [96:0] enable_s1_agent_rp_data;                                                            // enable_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [96:0] cmd_demux_src4_data;                                                                // cmd_demux:src4_data -> crosser_002:in_data
	wire         cmd_demux_src4_ready;                                                               // crosser_002:in_ready -> cmd_demux:src4_ready
	wire   [8:0] cmd_demux_src4_channel;                                                             // cmd_demux:src4_channel -> crosser_002:in_channel
	...
	wire  [96:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_004:sink0_data
	...
	wire  [96:0] cmd_demux_src5_data;                                                                // cmd_demux:src5_data -> crosser_003:in_data
	wire         cmd_demux_src5_ready;                                                               // crosser_003:in_ready -> cmd_demux:src5_ready
	wire   [8:0] cmd_demux_src5_channel;                                                             // cmd_demux:src5_channel -> crosser_003:in_channel
	...
	wire  [96:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux_005:sink0_data
	...
	wire  [96:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> crosser_004:in_data
	wire         rsp_demux_002_src0_ready;                                                           // crosser_004:in_ready -> rsp_demux_002:src0_ready
	wire   [8:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_004:in_channel
	...
	wire  [96:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux:sink2_data
	wire         crosser_004_out_ready;                                                              // rsp_mux:sink2_ready -> crosser_004:out_ready
	wire   [8:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink2_channel
	...
	wire  [96:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_005:in_data
	wire         rsp_demux_003_src0_ready;                                                           // crosser_005:in_ready -> rsp_demux_003:src0_ready
	wire   [8:0] rsp_demux_003_src0_channel;                                                         // rsp_demux_003:src0_channel -> crosser_005:in_channel
	...
	wire  [96:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux:sink3_data
	wire         crosser_005_out_ready;                                                              // rsp_mux:sink3_ready -> crosser_005:out_ready
	wire   [8:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux:sink3_channel
	...
	wire  [96:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_006:in_data
	wire         rsp_demux_004_src0_ready;                                                           // crosser_006:in_ready -> rsp_demux_004:src0_ready
	wire   [8:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_006:in_channel
	...
	wire  [96:0] crosser_006_out_data;                                                               // crosser_006:out_data -> rsp_mux:sink4_data
	wire         crosser_006_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_006:out_ready
	wire   [8:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink4_channel
	...
	wire  [96:0] rsp_demux_005_src0_data;                                                            // rsp_demux_005:src0_data -> crosser_007:in_data
	wire         rsp_demux_005_src0_ready;                                                           // crosser_007:in_ready -> rsp_demux_005:src0_ready
	wire   [8:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_007:in_channel
	...
	wire  [96:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux:sink5_data
	wire         crosser_007_out_ready;                                                              // rsp_mux:sink5_ready -> crosser_007:out_ready
	wire   [8:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux:sink5_channel
	...
	wire         fifo_resultados_fase_out_agent_rdata_fifo_out_valid;                                // fifo_resultados_fase_out_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] fifo_resultados_fase_out_agent_rdata_fifo_out_data;                                 // fifo_resultados_fase_out_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire         fifo_resultados_fase_out_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_002:in_0_ready -> fifo_resultados_fase_out_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> fifo_resultados_fase_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> fifo_resultados_fase_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // fifo_resultados_fase_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> fifo_resultados_fase_out_agent:rdata_fifo_sink_error
	wire         fifo_resultados_cuad_out_agent_rdata_fifo_out_valid;                                // fifo_resultados_cuad_out_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] fifo_resultados_cuad_out_agent_rdata_fifo_out_data;                                 // fifo_resultados_cuad_out_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire         fifo_resultados_cuad_out_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_003:in_0_ready -> fifo_resultados_cuad_out_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> fifo_resultados_cuad_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> fifo_resultados_cuad_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // fifo_resultados_cuad_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> fifo_resultados_cuad_out_agent:rdata_fifo_sink_error
	wire         fifo_fft_real_out_agent_rdata_fifo_out_valid;                                       // fifo_fft_real_out_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] fifo_fft_real_out_agent_rdata_fifo_out_data;                                        // fifo_fft_real_out_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire         fifo_fft_real_out_agent_rdata_fifo_out_ready;                                       // avalon_st_adapter_004:in_0_ready -> fifo_fft_real_out_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> fifo_fft_real_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> fifo_fft_real_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // fifo_fft_real_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> fifo_fft_real_out_agent:rdata_fifo_sink_error
	wire         fifo_fft_imag_out_agent_rdata_fifo_out_valid;                                       // fifo_fft_imag_out_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] fifo_fft_imag_out_agent_rdata_fifo_out_data;                                        // fifo_fft_imag_out_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire         fifo_fft_imag_out_agent_rdata_fifo_out_ready;                                       // avalon_st_adapter_005:in_0_ready -> fifo_fft_imag_out_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> fifo_fft_imag_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> fifo_fft_imag_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // fifo_fft_imag_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> fifo_fft_imag_out_agent:rdata_fifo_sink_error
	...
	wire         enable_s1_agent_rdata_fifo_src_valid;                                               // enable_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] enable_s1_agent_rdata_fifo_src_data;                                                // enable_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         enable_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_008:in_0_ready -> enable_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> enable_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> enable_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // enable_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> enable_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fifo_resultados_fase_out_translator (
		.clk                    (pll_0_outclk0_clk),                                         //                      clk.clk
		.reset                  (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fifo_resultados_fase_out_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (fifo_resultados_fase_out_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (fifo_resultados_fase_out_agent_m0_read),                    //                         .read
		.uav_write              (fifo_resultados_fase_out_agent_m0_write),                   //                         .write
		.uav_waitrequest        (fifo_resultados_fase_out_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (fifo_resultados_fase_out_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (fifo_resultados_fase_out_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (fifo_resultados_fase_out_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (fifo_resultados_fase_out_agent_m0_writedata),               //                         .writedata
		.uav_lock               (fifo_resultados_fase_out_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (fifo_resultados_fase_out_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (fifo_resultados_fase_out_address),                          //      avalon_anti_slave_0.address
		.av_read                (fifo_resultados_fase_out_read),                             //                         .read
		.av_readdata            (fifo_resultados_fase_out_readdata),                         //                         .readdata
		.av_write               (),                                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fifo_resultados_cuad_out_translator (
		.clk                    (pll_0_outclk0_clk),                                         //                      clk.clk
		.reset                  (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fifo_resultados_cuad_out_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (fifo_resultados_cuad_out_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (fifo_resultados_cuad_out_agent_m0_read),                    //                         .read
		.uav_write              (fifo_resultados_cuad_out_agent_m0_write),                   //                         .write
		.uav_waitrequest        (fifo_resultados_cuad_out_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (fifo_resultados_cuad_out_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (fifo_resultados_cuad_out_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (fifo_resultados_cuad_out_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (fifo_resultados_cuad_out_agent_m0_writedata),               //                         .writedata
		.uav_lock               (fifo_resultados_cuad_out_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (fifo_resultados_cuad_out_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (fifo_resultados_cuad_out_address),                          //      avalon_anti_slave_0.address
		.av_read                (fifo_resultados_cuad_out_read),                             //                         .read
		.av_readdata            (fifo_resultados_cuad_out_readdata),                         //                         .readdata
		.av_write               (),                                                          //              (terminated)
		.av_writedata           (),                                                          //              (terminated)
		.av_begintransfer       (),                                                          //              (terminated)
		.av_beginbursttransfer  (),                                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fifo_fft_real_out_translator (
		.clk                    (pll_0_outclk0_clk),                                         //                      clk.clk
		.reset                  (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fifo_fft_real_out_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (fifo_fft_real_out_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (fifo_fft_real_out_agent_m0_read),                           //                         .read
		.uav_write              (fifo_fft_real_out_agent_m0_write),                          //                         .write
		.uav_waitrequest        (fifo_fft_real_out_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (fifo_fft_real_out_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (fifo_fft_real_out_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (fifo_fft_real_out_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (fifo_fft_real_out_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (fifo_fft_real_out_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (fifo_fft_real_out_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (fifo_fft_real_out_address),                                 //      avalon_anti_slave_0.address
		.av_read                (fifo_fft_real_out_read),                                    //                         .read
		.av_readdata            (fifo_fft_real_out_readdata),                                //                         .readdata
		.av_write               (),                                                          //              (terminated)
		.av_writedata           (),                                                          //              (terminated)
		.av_begintransfer       (),                                                          //              (terminated)
		.av_beginbursttransfer  (),                                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fifo_fft_imag_out_translator (
		.clk                    (pll_0_outclk0_clk),                                         //                      clk.clk
		.reset                  (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fifo_fft_imag_out_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (fifo_fft_imag_out_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (fifo_fft_imag_out_agent_m0_read),                           //                         .read
		.uav_write              (fifo_fft_imag_out_agent_m0_write),                          //                         .write
		.uav_waitrequest        (fifo_fft_imag_out_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (fifo_fft_imag_out_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (fifo_fft_imag_out_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (fifo_fft_imag_out_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (fifo_fft_imag_out_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (fifo_fft_imag_out_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (fifo_fft_imag_out_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (fifo_fft_imag_out_address),                                 //      avalon_anti_slave_0.address
		.av_read                (fifo_fft_imag_out_read),                                    //                         .read
		.av_readdata            (fifo_fft_imag_out_readdata),                                //                         .readdata
		.av_write               (),                                                          //              (terminated)
		.av_writedata           (),                                                          //              (terminated)
		.av_begintransfer       (),                                                          //              (terminated)
		.av_beginbursttransfer  (),                                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fifo_resultados_fase_out_agent (
		.clk                     (pll_0_outclk0_clk),                                         //             clk.clk
		.reset                   (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (fifo_resultados_fase_out_agent_m0_address),                 //              m0.address
		.m0_burstcount           (fifo_resultados_fase_out_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (fifo_resultados_fase_out_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (fifo_resultados_fase_out_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (fifo_resultados_fase_out_agent_m0_lock),                    //                .lock
		.m0_readdata             (fifo_resultados_fase_out_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (fifo_resultados_fase_out_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (fifo_resultados_fase_out_agent_m0_read),                    //                .read
		.m0_waitrequest          (fifo_resultados_fase_out_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (fifo_resultados_fase_out_agent_m0_writedata),               //                .writedata
		.m0_write                (fifo_resultados_fase_out_agent_m0_write),                   //                .write
		.rp_endofpacket          (fifo_resultados_fase_out_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (fifo_resultados_fase_out_agent_rp_ready),                   //                .ready
		.rp_valid                (fifo_resultados_fase_out_agent_rp_valid),                   //                .valid
		.rp_data                 (fifo_resultados_fase_out_agent_rp_data),                    //                .data
		.rp_startofpacket        (fifo_resultados_fase_out_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (fifo_resultados_fase_out_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (fifo_resultados_fase_out_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (fifo_resultados_fase_out_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (fifo_resultados_fase_out_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (fifo_resultados_fase_out_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (fifo_resultados_fase_out_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (fifo_resultados_fase_out_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (fifo_resultados_fase_out_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (fifo_resultados_fase_out_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (fifo_resultados_fase_out_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (fifo_resultados_fase_out_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fifo_resultados_fase_out_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (fifo_resultados_fase_out_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_resultados_fase_out_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_resultados_fase_out_agent_rf_source_data),             //        in.data
		.in_valid          (fifo_resultados_fase_out_agent_rf_source_valid),            //          .valid
		.in_ready          (fifo_resultados_fase_out_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fifo_resultados_fase_out_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fifo_resultados_fase_out_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fifo_resultados_fase_out_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fifo_resultados_fase_out_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fifo_resultados_fase_out_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fifo_resultados_fase_out_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fifo_resultados_fase_out_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_resultados_fase_out_agent_rdata_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_resultados_fase_out_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (fifo_resultados_fase_out_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (fifo_resultados_fase_out_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (fifo_resultados_fase_out_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (fifo_resultados_fase_out_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (fifo_resultados_fase_out_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fifo_resultados_cuad_out_agent (
		.clk                     (pll_0_outclk0_clk),                                         //             clk.clk
		.reset                   (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (fifo_resultados_cuad_out_agent_m0_address),                 //              m0.address
		.m0_burstcount           (fifo_resultados_cuad_out_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (fifo_resultados_cuad_out_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (fifo_resultados_cuad_out_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (fifo_resultados_cuad_out_agent_m0_lock),                    //                .lock
		.m0_readdata             (fifo_resultados_cuad_out_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (fifo_resultados_cuad_out_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (fifo_resultados_cuad_out_agent_m0_read),                    //                .read
		.m0_waitrequest          (fifo_resultados_cuad_out_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (fifo_resultados_cuad_out_agent_m0_writedata),               //                .writedata
		.m0_write                (fifo_resultados_cuad_out_agent_m0_write),                   //                .write
		.rp_endofpacket          (fifo_resultados_cuad_out_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (fifo_resultados_cuad_out_agent_rp_ready),                   //                .ready
		.rp_valid                (fifo_resultados_cuad_out_agent_rp_valid),                   //                .valid
		.rp_data                 (fifo_resultados_cuad_out_agent_rp_data),                    //                .data
		.rp_startofpacket        (fifo_resultados_cuad_out_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (fifo_resultados_cuad_out_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (fifo_resultados_cuad_out_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (fifo_resultados_cuad_out_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (fifo_resultados_cuad_out_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (fifo_resultados_cuad_out_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (fifo_resultados_cuad_out_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (fifo_resultados_cuad_out_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (fifo_resultados_cuad_out_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (fifo_resultados_cuad_out_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (fifo_resultados_cuad_out_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (fifo_resultados_cuad_out_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fifo_resultados_cuad_out_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (fifo_resultados_cuad_out_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_resultados_cuad_out_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_resultados_cuad_out_agent_rf_source_data),             //        in.data
		.in_valid          (fifo_resultados_cuad_out_agent_rf_source_valid),            //          .valid
		.in_ready          (fifo_resultados_cuad_out_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fifo_resultados_cuad_out_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fifo_resultados_cuad_out_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fifo_resultados_cuad_out_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fifo_resultados_cuad_out_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fifo_resultados_cuad_out_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fifo_resultados_cuad_out_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fifo_resultados_cuad_out_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_resultados_cuad_out_agent_rdata_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_resultados_cuad_out_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (fifo_resultados_cuad_out_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (fifo_resultados_cuad_out_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (fifo_resultados_cuad_out_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (fifo_resultados_cuad_out_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (fifo_resultados_cuad_out_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fifo_fft_real_out_agent (
		.clk                     (pll_0_outclk0_clk),                                         //             clk.clk
		.reset                   (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (fifo_fft_real_out_agent_m0_address),                        //              m0.address
		.m0_burstcount           (fifo_fft_real_out_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (fifo_fft_real_out_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (fifo_fft_real_out_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (fifo_fft_real_out_agent_m0_lock),                           //                .lock
		.m0_readdata             (fifo_fft_real_out_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (fifo_fft_real_out_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (fifo_fft_real_out_agent_m0_read),                           //                .read
		.m0_waitrequest          (fifo_fft_real_out_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (fifo_fft_real_out_agent_m0_writedata),                      //                .writedata
		.m0_write                (fifo_fft_real_out_agent_m0_write),                          //                .write
		.rp_endofpacket          (fifo_fft_real_out_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (fifo_fft_real_out_agent_rp_ready),                          //                .ready
		.rp_valid                (fifo_fft_real_out_agent_rp_valid),                          //                .valid
		.rp_data                 (fifo_fft_real_out_agent_rp_data),                           //                .data
		.rp_startofpacket        (fifo_fft_real_out_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (fifo_fft_real_out_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (fifo_fft_real_out_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (fifo_fft_real_out_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (fifo_fft_real_out_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (fifo_fft_real_out_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (fifo_fft_real_out_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (fifo_fft_real_out_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (fifo_fft_real_out_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (fifo_fft_real_out_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (fifo_fft_real_out_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (fifo_fft_real_out_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fifo_fft_real_out_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (fifo_fft_real_out_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_fft_real_out_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_fft_real_out_agent_rf_source_data),                    //        in.data
		.in_valid          (fifo_fft_real_out_agent_rf_source_valid),                   //          .valid
		.in_ready          (fifo_fft_real_out_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (fifo_fft_real_out_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (fifo_fft_real_out_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (fifo_fft_real_out_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (fifo_fft_real_out_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (fifo_fft_real_out_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (fifo_fft_real_out_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (fifo_fft_real_out_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_fft_real_out_agent_rdata_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_fft_real_out_agent_rdata_fifo_src_data),               //        in.data
		.in_valid          (fifo_fft_real_out_agent_rdata_fifo_src_valid),              //          .valid
		.in_ready          (fifo_fft_real_out_agent_rdata_fifo_src_ready),              //          .ready
		.out_data          (fifo_fft_real_out_agent_rdata_fifo_out_data),               //       out.data
		.out_valid         (fifo_fft_real_out_agent_rdata_fifo_out_valid),              //          .valid
		.out_ready         (fifo_fft_real_out_agent_rdata_fifo_out_ready),              //          .ready
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fifo_fft_imag_out_agent (
		.clk                     (pll_0_outclk0_clk),                                         //             clk.clk
		.reset                   (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (fifo_fft_imag_out_agent_m0_address),                        //              m0.address
		.m0_burstcount           (fifo_fft_imag_out_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (fifo_fft_imag_out_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (fifo_fft_imag_out_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (fifo_fft_imag_out_agent_m0_lock),                           //                .lock
		.m0_readdata             (fifo_fft_imag_out_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (fifo_fft_imag_out_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (fifo_fft_imag_out_agent_m0_read),                           //                .read
		.m0_waitrequest          (fifo_fft_imag_out_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (fifo_fft_imag_out_agent_m0_writedata),                      //                .writedata
		.m0_write                (fifo_fft_imag_out_agent_m0_write),                          //                .write
		.rp_endofpacket          (fifo_fft_imag_out_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (fifo_fft_imag_out_agent_rp_ready),                          //                .ready
		.rp_valid                (fifo_fft_imag_out_agent_rp_valid),                          //                .valid
		.rp_data                 (fifo_fft_imag_out_agent_rp_data),                           //                .data
		.rp_startofpacket        (fifo_fft_imag_out_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (fifo_fft_imag_out_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (fifo_fft_imag_out_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (fifo_fft_imag_out_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (fifo_fft_imag_out_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (fifo_fft_imag_out_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (fifo_fft_imag_out_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (fifo_fft_imag_out_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (fifo_fft_imag_out_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (fifo_fft_imag_out_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (fifo_fft_imag_out_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (fifo_fft_imag_out_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fifo_fft_imag_out_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (fifo_fft_imag_out_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_fft_imag_out_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_fft_imag_out_agent_rf_source_data),                    //        in.data
		.in_valid          (fifo_fft_imag_out_agent_rf_source_valid),                   //          .valid
		.in_ready          (fifo_fft_imag_out_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (fifo_fft_imag_out_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (fifo_fft_imag_out_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (fifo_fft_imag_out_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (fifo_fft_imag_out_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (fifo_fft_imag_out_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (fifo_fft_imag_out_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (fifo_fft_imag_out_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_fft_imag_out_agent_rdata_fifo (
		.clk               (pll_0_outclk0_clk),                                         //       clk.clk
		.reset             (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_fft_imag_out_agent_rdata_fifo_src_data),               //        in.data
		.in_valid          (fifo_fft_imag_out_agent_rdata_fifo_src_valid),              //          .valid
		.in_ready          (fifo_fft_imag_out_agent_rdata_fifo_src_ready),              //          .ready
		.out_data          (fifo_fft_imag_out_agent_rdata_fifo_out_data),               //       out.data
		.out_valid         (fifo_fft_imag_out_agent_rdata_fifo_out_valid),              //          .valid
		.out_ready         (fifo_fft_imag_out_agent_rdata_fifo_out_ready),              //          .ready
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	procesador_mm_interconnect_0_router_002 router_002 (
	...
	procesador_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (fifo_resultados_fase_out_agent_rp_ready),                   //      sink.ready
		.sink_valid         (fifo_resultados_fase_out_agent_rp_valid),                   //          .valid
		.sink_data          (fifo_resultados_fase_out_agent_rp_data),                    //          .data
		.sink_startofpacket (fifo_resultados_fase_out_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (fifo_resultados_fase_out_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (fifo_resultados_cuad_out_agent_rp_ready),                   //      sink.ready
		.sink_valid         (fifo_resultados_cuad_out_agent_rp_valid),                   //          .valid
		.sink_data          (fifo_resultados_cuad_out_agent_rp_data),                    //          .data
		.sink_startofpacket (fifo_resultados_cuad_out_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (fifo_resultados_cuad_out_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (fifo_fft_real_out_agent_rp_ready),                          //      sink.ready
		.sink_valid         (fifo_fft_real_out_agent_rp_valid),                          //          .valid
		.sink_data          (fifo_fft_real_out_agent_rp_data),                           //          .data
		.sink_startofpacket (fifo_fft_real_out_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (fifo_fft_real_out_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (fifo_fft_imag_out_agent_rp_ready),                          //      sink.ready
		.sink_valid         (fifo_fft_imag_out_agent_rp_valid),                          //          .valid
		.sink_data          (fifo_fft_imag_out_agent_rp_data),                           //          .data
		.sink_startofpacket (fifo_fft_imag_out_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (fifo_fft_imag_out_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_router_003 router_008 (
	...
	procesador_mm_interconnect_0_router_002 router_009 (
	...
	procesador_mm_interconnect_0_router_002 router_010 (
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                                         //       clk.clk
		.reset               (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                                         //       clk.clk
		.reset               (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (pll_0_outclk0_clk),                                         //       clk.clk
		.reset               (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_0_outclk0_clk),                                         //       clk.clk
		.reset               (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                                         //       clk.clk
		.reset              (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_cmd_demux_001 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	procesador_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	procesador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo_resultados_fase_out_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (fifo_resultados_fase_out_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (fifo_resultados_fase_out_agent_rdata_fifo_out_ready),       //         .ready
	...
	procesador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo_resultados_cuad_out_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (fifo_resultados_cuad_out_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (fifo_resultados_cuad_out_agent_rdata_fifo_out_ready),       //         .ready
	...
	procesador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo_fft_real_out_agent_rdata_fifo_out_data),               //     in_0.data
		.in_0_valid     (fifo_fft_real_out_agent_rdata_fifo_out_valid),              //         .valid
		.in_0_ready     (fifo_fft_real_out_agent_rdata_fifo_out_ready),              //         .ready
	...
	procesador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (fifo_resultados_fase_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo_fft_imag_out_agent_rdata_fifo_out_data),               //     in_0.data
		.in_0_valid     (fifo_fft_imag_out_agent_rdata_fifo_out_valid),              //         .valid
		.in_0_ready     (fifo_fft_imag_out_agent_rdata_fifo_out_ready),              //         .ready
